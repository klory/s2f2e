...
class Option(object):
    def __init__(self):
        ...
        self.opt = add_arguments(self.parser).parse_args()
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--no_dropout", type="bool", narg="?", const=True, default=False, help="whether to use dropout.")
        parser.add_argument("--use_sigmoid", type="bool", nargs="?", const=True, defautl=False, help="whether to use sigmoid.")
        ...
        parser.add_argument("--model", type=str, default="NFG", help="which model to implement: EFG, NFG, NFG_WGAN, EFG_WGAN, WGAN, E2E")
