...
class Option(object):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--learning_rate_adam", type=float, default=0.0002, help="learning rate")
        parser.add_argument("--learning_rate_rmsprop", type=float, default=0.00005, help="learning rate")
