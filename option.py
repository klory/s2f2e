...
class Option(object):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--lam_gp", type=int, default=10, help="Gradient penalty coefficient.")

        parser.add_argument("--beta1_ls", type=float, default=0.5, help="beta1 of adam for LSGAN")
        parser.add_argument("--beta2_ls", type=float, default=0.999, help="beta2 of adam LSGAN")
        parser.add_argument("--beta1_wgan", type=float, default=0., help="beta1 of adam for WGAN")
        parser.add_argument("--beta2_wgan", type=float, default=0.9, help="beta2 of adam for WGAN")
        parser.add_argument("--learning_rate_ls", type=float, default=0.0002, help="learning rate for LSGAN")
        parser.add_argument("--learning_rate_wgan", type=float, default=0.0001, help="learning rate for WGAN")
        parser.add_argument("--n_critic", type=int, default=5, help="updating balance coefficient between D and G in WGAN")
